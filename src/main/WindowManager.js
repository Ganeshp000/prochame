...
class WindowManager {
  ...
  createWindow() {
    ...
    const noProtect = !!process.env.PROCHAME_NO_PROTECT;
    ...
    // Open DevTools automatically when PROCHAME_DEBUG=1 is set (works in production)
    const isDebug = process.env.PROCHAME_DEBUG === '1';
    if (isDev || isDebug) {
